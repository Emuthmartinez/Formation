...
It does not cover apps launched with this skill. Those get their own security plan from `templates/SECURITY.md`, which is a different document for a different audience: the threat model, hardening, and release gates of a shipped consumer app.
