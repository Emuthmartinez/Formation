...
1. Confirm the product shape via **AskUserQuestion** (habit model, primary surface, optional systems, niche) — see the reference. Record it in `state/PROJECT_STATE.yaml`.
