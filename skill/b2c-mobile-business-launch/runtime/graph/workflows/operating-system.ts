...
export const workflows = [
  ...
  workflow({
    ...
    outputPaths: ["state/PROJECT_STATE.yaml", "state/launch-cockpit.html", "operations/BUSINESS_ACCESS.md"],
  ...
  workflow({
    ...
    laneIds: [],
    outputPaths: ["state/PROJECT_STATE.yaml", "state/LAUNCH_TRACE.md"],
