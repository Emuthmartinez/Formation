...
export function renderGeneratedFiles(graph: SkillGraph): Record<string, string> {
  return {
    "runtime/graph/generated/skill-graph.json": `${JSON.stringify(graph, null, 2)}\n`,
    "runtime/graph/generated/skill-graph.md": renderGraphMarkdown(graph),
    "runtime/graph/generated/skill-graph.mmd": renderMermaid(graph),
    "runtime/graph/generated/context-report.json": `${JSON.stringify(contextReport(graph), null, 2)}\n`,
  };
}
