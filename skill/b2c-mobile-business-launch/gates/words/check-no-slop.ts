 ...
 * Usage: tsx gates/words/check-no-slop.ts --skill-root /path/to/skill [--root /path/to/templates] [--repo-root /path/to/repo]
 */
import { existsSync, readFileSync, readdirSync, statSync } from "node:fs";
import path from "node:path";
import { fileURLToPath } from "node:url";
import { flagString, issue, parseFlags, reportAndExit, type Issue } from "../../scripts/lib/launch-state.js";
import { emDashProblem, loadNoSlopRules, matchesTerm, slopPatterns } from "../../scripts/lib/no-slop-rules.js";
