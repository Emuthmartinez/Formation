 ...
 *   - the social-network lane is wired: playbook/product/social-network.md exists,
 ...
 * Usage: tsx gates/product/check-app-archetype.ts --skill-root /path/to/skill
 */
...
const SHIPPED_PACKS: ShippedPack[] = [
  {
    ...
    reference: "playbook/product/social-network.md",
    eval: "machine/evals/agent-behavior/social-network-archetype-prompt-pack.yaml",
    starter: true,
  },
  {
    ...
    reference: "playbook/product/ai-chat-companion.md",
    eval: "machine/evals/agent-behavior/ai-chat-companion-archetype-prompt-pack.yaml",
    starter: true,
  },
  {
    name: "habit-tracker",
    requiredPrompts: ["01-database-schema.md", "02-auth-system.md", "03-habit-core-loop.md", "04-reminders-and-streaks.md"],
    reference: "playbook/product/habit-tracker.md",
    eval: "machine/evals/agent-behavior/habit-tracker-archetype-prompt-pack.yaml",
    starter: true,
  },
  {
    name: "photo-ai-media",
    requiredPrompts: ["01-database-schema.md", "02-auth-system.md", "03-capture-and-library.md", "04-ai-generation-pipeline.md"],
    reference: "playbook/product/photo-ai-media.md",
    eval: "machine/evals/agent-behavior/photo-ai-media-archetype-prompt-pack.yaml",
    starter: true,
  },
];
