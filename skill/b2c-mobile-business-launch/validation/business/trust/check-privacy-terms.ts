 ...
 * knowledge/process/artifact-contracts.md. Founder/legal approval remains the final
 * gate — this validator enforces the structural floor, not legal adequacy.
 *
 * npm script: check:privacy-terms
 * Usage: tsx validation/business/trust/check-privacy-terms.ts --root <app-repo-root>
 */
