 ...
 * state/LAUNCH_TRACE.md contract in knowledge/process/artifact-contracts.md.
 *
 * npm script: check:launch-trace
 * Usage: tsx validation/business/process/check-launch-trace.ts --root <app-repo-root>
 */
