...
import { flagString, isRecord, parseFlags } from "../../../tooling/lib/launch-state.js";
...
function contractPaths(args: Args): ContractPaths {
  if (args.mode === "skill") {
    return {
      agents: path.join(args.skillRoot, "workspace/business/engineering/repo-agent-entrypoints/AGENTS.md"),
      claude: path.join(args.skillRoot, "workspace/business/engineering/repo-agent-entrypoints/CLAUDE.md"),
      appAgents: path.join(args.skillRoot, "workspace/business/engineering/app-agent-roster/APP_AGENTS.md"),
      specialistPrompts: specialistPromptNames().map((fileName) => ({
        label: fileName,
        filePath: path.join(args.skillRoot, "workspace/business/engineering/app-agent-roster/agents", fileName),
      })),
      orchestrator: path.join(args.skillRoot, "workspace/business/engineering/app-agent-roster/agents/orchestrator.md"),
      orchestration: path.join(args.skillRoot, "workspace/business/operations/ORCHESTRATION.md"),
      projectState: path.join(args.skillRoot, "workspace/business/state/PROJECT_STATE.yaml"),
    };
  }
