...
import { flagString, type Issue, issue, parseFlags, reportAndExit } from "../../../tooling/lib/launch-state.js";
...
const templateRoot = path.join(skillRoot, "workspace", "business", "engineering/repo-agent-entrypoints");
...
const appAgentsPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "APP_AGENTS.md");
const designGuruPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "agents", "design-guru.md");
const productLeaderPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "agents", "product-leader.md");
const marketingGuruPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "agents", "marketing-guru.md");
const customerSuccessPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "agents", "customer-success.md");
const engineeringLeaderPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "agents", "engineering-leader.md");
const securityArchitectPath = path.join(skillRoot, "workspace", "business", "engineering/app-agent-roster", "agents", "security-architect.md");
...
if (repoRoot) {
  ...
  if (repoAgents) {
    requireTerms(
      ...
      [
        ...
        "workspace/business/engineering/repo-agent-entrypoints",
        "Runtime Sync",
        "Source Freshness",
      ],
      "repo_agents",
  ...
  if (repoClaude) {
    requireTerms(
      repoClaude,
      ["maintainer-only", "Do not copy it into businesses created by the skill", "workspace/business/engineering/repo-agent-entrypoints/CLAUDE.md"],
      "repo_claude",
      repoClaudePath,
      issues,
    );
