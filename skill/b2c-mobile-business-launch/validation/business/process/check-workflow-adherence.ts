...
const parallelPath = path.join(skillRoot, "knowledge", "orchestration", "parallel-agent-orchestration.md");
const engineeringPath = path.join(skillRoot, "knowledge", "engineering", "engineering-orchestration.md");
// The CE routing contract lives in the engineering lane of the split
// tool-recipes surface; the index only routes to it.
const toolRecipesPath = path.join(skillRoot, "knowledge", "process", "tool-recipes", "engineering-and-agent-orchestration.md");
const compoundEngineeringPath = path.join(skillRoot, "knowledge", "orchestration", "compound-engineering-routing.md");
const templateAgentsPath = path.join(skillRoot, "workspace", "business", "engineering/repo-agent-entrypoints", "AGENTS.md");
const templateClaudePath = path.join(skillRoot, "workspace", "business", "engineering/repo-agent-entrypoints", "CLAUDE.md");
const orchestrationTemplatePath = path.join(skillRoot, "workspace", "business", "operations/ORCHESTRATION.md");
const projectStateTemplatePath = path.join(skillRoot, "workspace", "business", "state/PROJECT_STATE.yaml");
const launchbenchDir = path.join(skillRoot, "validation", "repository", "evals", "launchbench");
