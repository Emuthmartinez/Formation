 ...
 * knowledge/process/artifact-contracts.md: the spec must explain why the app can
 * win, name the magical V1 moment, and bound V1 before engineering planning.
 *
 * npm script: check:product-spec
 * Usage: tsx validation/business/product/check-product-spec.ts --root <app-repo-root>
 */
