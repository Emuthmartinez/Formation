...
export const workflows = [
  ...
  workflow({
    ...
    outputPaths: ["state/business.json", "state/theme.tokens.json", "design/design-room.html"],
  ...
  workflow({
    ...
    laneIds: ["lane.design"],
    outputPaths: ["design/DESIGN.md", "product/experience/ux-patterns/UX_PATTERNS.md"],
