...
export const workflows = [
  ...
  workflow({
    ...
    outputPaths: ["app-store-listing/APP_STORE_LISTING.md"],
  ...
  workflow({
    ...
    outputPaths: ["APPLE_APP_STORE_REQUIREMENTS.md"],
  ...
  workflow({
    ...
    outputPaths: ["STORE_CONSOLE.md", "store-console.html"],
    gates: ["check:store-console"],
  ...
  workflow({
    ...
    outputPaths: ["app-store-listing/SCREENSHOTS.md"],
  ...
  workflow({
    ...
    phaseIds: ["phase.3"],
    dependencies: ["workflow.store.app-store-listing-prep-packet"],
    outputPaths: ["GOOGLE_PLAY_RELEASE.md"],
  ...
  workflow({
    ...
    outputPaths: ["ENGINEERING_PLAN.md", "ORCHESTRATION.md", "PRODUCTION_READINESS.md"],
  ...
  workflow({
    ...
    phaseIds: ["phase.5b"],
    dependencies: ["workflow.engineering.engineering-orchestration-ce-production-readiness"],
    outputPaths: ["DEMO_VIDEO.md", "PRODUCTION_READINESS.md"],
  ...
  workflow({
    ...
    phaseIds: ["phase.5b"],
    dependencies: ["workflow.engineering.engineering-orchestration-ce-production-readiness"],
    outputPaths: ["PRODUCTION_READINESS.md"],
