...
export const workflows = [
  ...
  workflow({
    ...
    outputPaths: ["machine/source-registry.yaml"],
  ...
  workflow({
    ...
    outputPaths: ["scripts/lib/founder-copy.ts"],
  ...
  workflow({
    ...
    outputPaths: ["playbook/store/app-store-connect-cli.md"],
  ...
  workflow({
    ...
    outputPaths: ["graph/generated/skill-graph.json", "graph/generated/skill-graph.md", "graph/generated/context-report.json"],
