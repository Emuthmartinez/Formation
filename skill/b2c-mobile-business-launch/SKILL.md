...
| Landing CRO | before building or auditing a public conversion surface: landing/waitlist, web-to-app, or launch page | [`references/cro-landing.md`](references/cro-landing.md) | structure, trust placement, viewport rules, friction audit; owns the web funnel, `onboarding-conversion.md` owns the in-app flow · `check:landing-funnel` |
| Conversion copy | before writing or editing conversion-critical words: hero/CTA, store title/subtitle/description, paywall and plan copy, value-reveal strings, email subjects, ad hooks | [`references/conversion-copy.md`](references/conversion-copy.md) | voice-of-customer mining, copy QA; owns the words, `cro-landing.md` owns the layout · `check:landing-funnel`, `check:no-slop` |
