...
| --- | --- | --- |
| start of multi-lane work; resuming a prior session; before provider/store mutations, handoff, or subagent dispatch; when rendering the cockpit | [`project-state.md`](./project-state.md) | `state/PROJECT_STATE.yaml`, `state/launch-cockpit.html`, `operations/ORCHESTRATION.md` · `check:orchestration` |
| start of multi-lane work; resuming a prior session; before provider/store mutations, handoff, or subagent dispatch; when rendering the cockpit | [`autonomy-modes.md`](./autonomy-modes.md) | `state/PROJECT_STATE.yaml`, `state/launch-cockpit.html`, `operations/ORCHESTRATION.md` · `check:orchestration` |
| start of multi-lane work; resuming a prior session; before provider/store mutations, handoff, or subagent dispatch; when rendering the cockpit | [`parallel-agent-orchestration.md`](./parallel-agent-orchestration.md) | `state/PROJECT_STATE.yaml`, `state/launch-cockpit.html`, `operations/ORCHESTRATION.md` · `check:orchestration` |
