...
export const references: readonly CatalogReference[] = [
  ...
  {
    id: "reference.engineering.technical-documentation-ste100",
    path: "knowledge/engineering/technical-documentation-ste100.md",
    domainId: "domain.engineering",
    title: "Technical Documentation In ASD-STE100",
    loadWhen:
  ...
  },
  {
    ...
    loadWhen:
      "Higgsfield or Remotion production routing, including the seven named chained recipes for ads/UGC/virality/seasonal restyle and the UGC-realism prompt structure for believable-person clips — routed from tool-recipes.md",
  },
