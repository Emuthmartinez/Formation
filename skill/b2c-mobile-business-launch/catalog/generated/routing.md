...
| first for any "run the app", "check this screen", "walk this flow", or "reproduce this bug" request on a local Mac — the Route Ladder starts at the zero-setup in-app iOS Simulator before XcodeBuildMCP CLI/MCP | [`knowledge/engineering/xcodebuildmcp-testing.md`](../../knowledge/engineering/xcodebuildmcp-testing.md) |
