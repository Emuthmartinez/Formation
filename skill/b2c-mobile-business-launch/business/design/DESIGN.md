...
Design proposals must use STATE -> MUTATE -> VERSION -> RENDER. Edit `state/business.json` and `state/theme.tokens.json`; render `design/design-room.html`; do not hand-author one-off visual proposals.
