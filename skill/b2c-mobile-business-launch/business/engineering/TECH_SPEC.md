...
The backend-agnostic contract the build must satisfy regardless of provider. See `playbook/engineering/backend-data-contract.md`; gate with `npm run check:backend-contract -- --root . --state state/PROJECT_STATE.yaml`.
