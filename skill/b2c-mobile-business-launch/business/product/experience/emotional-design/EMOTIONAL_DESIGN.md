...
Add all events below to `analytics/ANALYTICS.md` before implementation. Do not invent names; use the stable catalog from `playbook/experience/emotional-experience-design.md §Analytics Events` and `playbook/experience/emotional-experience-measurement.md §System Events`.
