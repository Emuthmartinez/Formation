...
const RUBRIC_DIMENSIONS = [
  ...
  { key: "brand_token_fidelity", weight: "MEDIUM", description: "Colors, type, and motion match studio/seed/theme.tokens.json" },
...
function emitGradingTaskTemplate(entries: SlotEntry[]): string {
  ...
  lines.push("");
  lines.push("```bash");
  lines.push("npx tsx tooling/grade-screenshots.ts \\");
