 ...
 *
 * The hooks in workspace/business/engineering/repo-agent-entrypoints/settings.json are the skill's
 ...
 * final PNG lands. validation/repository/fixtures/hooks.fixtures.ts already proves those
 ...
 * Usage: tsx tooling/install-hooks.ts --target /path/to/business-repo [--skill-root /path/to/skill]
