...
Status: partial until pricing, subscriptions, user content, support, and refund paths are reviewed.

This starter is not legal advice. Use it as a checklist for founder/legal review; founder/legal approval is required before publishing as final.

Effective date: YYYY-MM-DD · Contracting entity: replace with legal/business entity.
...
Apple/Google platform terms notes, including whether the app relies on Apple's standard EULA or custom terms.
