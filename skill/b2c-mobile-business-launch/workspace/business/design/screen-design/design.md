...
This starter records the screen-level product design contract. Keep `design/DESIGN.md`
...
- Onboarding contract: `product/ONBOARDING.md`
...
- Keep copy, spacing, components, and motion tied to `design/DESIGN.md`. Motion durations/easing
