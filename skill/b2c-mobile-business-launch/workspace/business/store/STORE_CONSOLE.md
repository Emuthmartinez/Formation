...
This packet is the copy-paste operator surface for App Store Connect and Google Play. Keep values aligned with `state/PROJECT_STATE.yaml`, `APP_STORE_LISTING.md`, `store/APPLE_APP_STORE_REQUIREMENTS.md`, `SCREENSHOTS.md`, `trust/PRIVACY.md`, `trust/TERMS.md`, `revenue/REVENUE_OPS.md`, and founder approval.
...
- Higgsfield can support app icons, backgrounds, CPP media, In-App Event media, and thumbnails when tied to `design/DESIGN.md` and `11_STAR_EXPERIENCE.md`.
