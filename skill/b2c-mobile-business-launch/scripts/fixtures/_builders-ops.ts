...
export function writeCompleteViralGrowth(root: string): void {
  ...
  writeFileSync(
    ...
    [
      ...
      "Loop Economics: k = invites per active user times recipient conversion, computed weekly with cycle time; k at 0.06 in week one means the loop is not yet a growth engine and the share moment is the next test.",
