 ...
 * Usage: tsx scripts/check-hooks-installed.ts --skill-root /path/to/skill [--root /path/to/business-repo]
 */
import { existsSync, readFileSync } from "node:fs";
import { spawnSync } from "node:child_process";
import path from "node:path";
import { fileURLToPath } from "node:url";
import { expandHome, flagString, issue, parseFlags, reportAndExit, type Issue } from "./lib/launch-state.js";
import {
