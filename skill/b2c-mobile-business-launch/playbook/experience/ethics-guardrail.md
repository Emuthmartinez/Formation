...
- `playbook/experience/eleven-star-experience.md` — star-ladder mapping required for every finding
- `playbook/data/analytics-attribution.md` — every emotional moment must emit a named PostHog event
- `playbook/experience/onboarding-conversion.md` — paywall timing, App Review popup placement, consent
- `playbook/process/failure-cards.md` — dark-pattern violations become failure cards
- `playbook/design/design-room.md` / `playbook/design/design-visual-system.md` — motion fallbacks required
