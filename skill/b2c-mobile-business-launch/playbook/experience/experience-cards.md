...
content here:
- `playbook/experience/eleven-star-experience.md` — star-ladder; every card maps to a level
- `playbook/design/quality-lens.md` — emotional job, not a generic SaaS wrapper
- `playbook/experience/onboarding-conversion.md` — paywall timing, App Review popup, consent
- `playbook/data/analytics-attribution.md` — every emotional moment needs a named PostHog event
- `playbook/design/design-room.md` / `playbook/design/design-visual-system.md` — motion tokens and
...
- `playbook/experience/ethics-guardrail.md` — Guardrail Contract, regulatory landscape, risk table
