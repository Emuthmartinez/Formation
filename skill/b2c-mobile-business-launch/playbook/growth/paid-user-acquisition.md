...
- before drafting ad headlines or primary/body text, load `playbook/words/no-slop-writing.md` — its §7 covers ad headline/primary-text limits; verify current platform character limits via the `ad-creative` skill or platform docs, and lead with the concrete benefit or hook, not a throat-clearing opener
