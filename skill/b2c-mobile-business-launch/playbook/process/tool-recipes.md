...
| Visual And Motion Production | Producing icons, mascots, screenshot art, ad creative, UGC video, app-preview B-roll, or any generated/rendered asset — holds the six canonical chained recipes | [`tool-recipes/visual-and-motion-production.md`](tool-recipes/visual-and-motion-production.md) — Higgsfield Visual And Motion Production; Higgsfield Chained Recipes; Remotion Content Asset Production |
