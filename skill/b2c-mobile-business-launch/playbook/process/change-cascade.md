...
| **Visual / UI / design-token change** | App Store screenshots (re-render) → App Preview → App Icon (if brand mark changed) → landing UI → email brand tokens → ad creative → `design/DESIGN.md` |
