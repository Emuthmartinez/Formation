 ...
 * Usage: tsx machine/check-reference-size.ts --skill-root /path/to/skill [--budget-bytes N]
 */
import { existsSync, readFileSync, readdirSync, statSync } from "node:fs";
import path from "node:path";
import { fileURLToPath } from "node:url";
import { flagNumber, flagString, issue, parseFlags, reportAndExit, type Issue } from "../scripts/lib/launch-state.js";
