...
export function validateBusinessState(value: unknown): ValidationResult<BusinessStateV2> {
  return validateAgainst<BusinessStateV2>("urn:b2c-mobile-business-launch:core:business-state-schema", value);
}

export function validateGrants(value: unknown): ValidationResult<GrantsDocument> {
  return validateAgainst<GrantsDocument>("urn:b2c-mobile-business-launch:core:grants-schema", value);
}

export function validateWaivers(value: unknown): ValidationResult<WaiversDocument> {
  const structural = validateAgainst<WaiversDocument>("urn:b2c-mobile-business-launch:core:waivers-schema", value);
...
export function validateBudgetLedger(value: unknown): ValidationResult<BudgetLedgerDocument> {
  return validateAgainst<BudgetLedgerDocument>("urn:b2c-mobile-business-launch:core:budget-ledger-schema", value);
}

export function validateControl(value: unknown): ValidationResult<ControlFile> {
  return validateAgainst<ControlFile>("urn:b2c-mobile-business-launch:core:control-schema", value);
}

export function validateRunState(value: unknown): ValidationResult<RunStateDocument> {
  return validateAgainst<RunStateDocument>("urn:b2c-mobile-business-launch:core:run-state-schema", value);
}

export function validateCheckpoint(value: unknown): ValidationResult<CheckpointDocument> {
  return validateAgainst<CheckpointDocument>("urn:b2c-mobile-business-launch:core:checkpoint-schema", value);
}
