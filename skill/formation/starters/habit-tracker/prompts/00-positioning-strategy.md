...
- Answers 1–3 define the wedge → `strategy/RESEARCH.md` and the 11-star magical moment (the check-in, prompt 03). A focused niche is the whole strategy; "habit tracker for everyone" is the losing default.
