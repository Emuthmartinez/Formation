...
const BUSINESS_STATE_SCHEMA = "urn:formation:core:business-state-schema";
const GRANTS_SCHEMA = "urn:formation:core:grants-schema";
const WAIVERS_SCHEMA = "urn:formation:core:waivers-schema";
const BUDGET_LEDGER_SCHEMA = "urn:formation:core:budget-ledger-schema";
const CONTROL_SCHEMA = "urn:formation:core:control-schema";
