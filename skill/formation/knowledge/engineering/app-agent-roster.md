...
- `AGENTS.md` tells future agents to keep using `formation`, update `state/business-state.json` only through the reducer, and run validators until a founder-only gate.
