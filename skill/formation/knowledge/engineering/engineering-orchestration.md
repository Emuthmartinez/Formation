...
- explicit instruction to keep using `formation` for broad launch/business work without requiring another founder prompt
...
- remind Claude to keep using `formation` for launch/business work
