...
Runnable reproductions of these recipes ship in [`business/design/motion-catalog/`](../../workspace/business/design/motion-catalog/README.md): two full-screen choreography exemplars (declarative and procedural modes), the closed-form `TokenSpring` evaluator, and the Remotion twin for token-true video renders.
