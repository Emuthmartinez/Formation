...
studio/seed/business.json       # Design Room source of truth for business identity, surfaces, version log, and control-plane panels
studio/seed/theme.tokens.json   # semantic design tokens consumed by Design Room render and downstream surfaces
...
- an explicit instruction to continue using the `formation` skill for broad launch/business work without asking the founder to re-invoke it
...
- one-line reminder to continue using `formation` for launch/business work without another founder prompt
