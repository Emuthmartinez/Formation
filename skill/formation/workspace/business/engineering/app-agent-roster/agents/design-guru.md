...
Audit gates:
- every design plan completes `design-evidence-stack.md` source triage before mutation, applies the Formation Craft Lens to substantive work, records the result in `design/design.md`, and uses two complementary behavior or structure sources for onboarding, paywall, core-loop, AI-trust, and store-first-frame decisions
