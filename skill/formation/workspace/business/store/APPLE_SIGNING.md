...
7. New compiled archive Info.plist identity and SDK keys [REVENUECAT_API_KEY, POSTHOG_API_KEY, SUPABASE_URL]; archive path={{RELEASE_ARCHIVE_PATH_XCARCHIVE}}; Info.plist SHA-256={{RELEASE_ARCHIVE_INFO_PLIST_SHA256_64_HEX}}: pass.
```
