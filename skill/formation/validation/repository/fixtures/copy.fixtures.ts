...
const AUTHORED_BRIEF = [
  ...
  "## Value proposition",
  "",
  "One small win a day, traced to the strategy/RESEARCH.md review-mining evidence rows.",
  "",
  "## Message hierarchy",
  "",
...
function stateWith(phase: string, lanes: Record<string, string>): string {
  const laneLines = Object.entries(lanes).flatMap(([lane, status]) => [
    `  ${lane}:`,
    `    status: "${status}"`,
    "    evidence:",
...
export function register(h: Harness): void {
  ...
  writeFileSync(path.join(deckPlaceholder, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckPlaceholder, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(deckVocabulary, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckVocabulary, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(deckAllowlisted, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckAllowlisted, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(deckAllowlisted, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  // The copied template product/ONBOARDING.md names prefixes this one-row deck cannot
  // cover; the fixture pins the allowlist behavior, so its screen table
  // references only the covered prefix.
  writeFileSync(
    path.join(deckAllowlisted, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy (from `product/copy/COPY_DECK.md`) | State |",
      "| --- | --- | --- | --- |",
  ...
  writeFileSync(path.join(deckIncomplete, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckIncomplete, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(deckDuplicate, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckDuplicate, "product/copy/COPY_DECK.md"),
    [
      ...DECK_HEADER,
  ...
  writeFileSync(path.join(deckMalformed, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckMalformed, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins | every day | | 1 |", ""].join("\n"),
    "utf8",
  );
  ...
  writeFileSync(path.join(onboardingVocabulary, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(onboardingVocabulary, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
  ...
  writeFileSync(path.join(deckIdentifier, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckIdentifier, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(deckMissing, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { onboarding: "done" }), "utf8");
  rmSync(path.join(deckMissing, "product/copy/COPY_DECK.md"));
  ...
  writeFileSync(path.join(deckTemplate, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  ...
  writeFileSync(path.join(liveGrandfather, "state/PROJECT_STATE.yaml"), stateWith("phase_6b", { design: "done" }), "utf8");
  writeFileSync(
    path.join(liveGrandfather, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Product-specific value promise | | 1 |", ""].join("\n"),
    "utf8",
  );
  ...
  // The product/ONBOARDING.md Copy column is scanned — the original leak site.
  const onboardingPlaceholder = makeFixture("app-copy-onboarding-placeholder");
  writeFileSync(path.join(onboardingPlaceholder, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(onboardingPlaceholder, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(externalizationMissing, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(path.join(externalizationMissing, "engineering/TECH_SPEC.md"), "# Technical Spec\n\nNo strings section.\n", "utf8");
  runFixture(
  ...
  writeFileSync(path.join(externalizationUnchosen, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  ...
  writeFileSync(path.join(externalizationNoSpec, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  rmSync(path.join(externalizationNoSpec, "engineering/TECH_SPEC.md"));
  ...
  writeFileSync(path.join(brandShipped, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  ...
  writeFileSync(path.join(onboardingMalformedRow, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(onboardingMalformedRow, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(onboardingBadRef, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(onboardingBadRef, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(paywallUncovered, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(paywallUncovered, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |", ""].join("\n"),
    "utf8",
  );
  writeFileSync(
    path.join(paywallUncovered, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy (from `product/copy/COPY_DECK.md`) | State |",
  ...
  writeFileSync(path.join(placeholderKey, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(placeholderKey, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.email.placeholder | Email field | you@example.com | input hint | 1 |", ""].join("\n"),
    "utf8",
  );
  writeFileSync(
    path.join(placeholderKey, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy (from `product/copy/COPY_DECK.md`) | State |",
  ...
  writeFileSync(path.join(deckDraft, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckDraft, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: draft",
  ...
  writeFileSync(
    path.join(deckDraft, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(deckSurfaceMissing, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckSurfaceMissing, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |", ""].join("\n"),
    "utf8",
  );
  writeFileSync(path.join(deckSurfaceMissing, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(deckSurfaceMissing, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(briefTemplate, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(briefTemplate, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |", ...NA_SURFACES, ""].join("\n"),
    "utf8",
  );
  writeFileSync(
    path.join(briefTemplate, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(engineeringNeedsDeck, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  rmSync(path.join(engineeringNeedsDeck, "product/copy/COPY_DECK.md"));
  ...
  writeFileSync(path.join(exactKeyMissing, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(exactKeyMissing, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline.body | Promise | Small wins, every day | | 1 |", ...NA_SURFACES, ""].join("\n"),
    "utf8",
  );
  writeFileSync(path.join(exactKeyMissing, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(exactKeyMissing, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(deckPipeState, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckPipeState, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(todoistClean, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(todoistClean, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.import.body | Import screen | Bring your tasks over from Todoist in one tap. | | 1 |", ""].join("\n"),
    "utf8",
  );
  writeFileSync(
    path.join(todoistClean, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(naPlaceholder, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(naPlaceholder, "product/copy/COPY_DECK.md"),
    [
      ...DECK_HEADER,
      "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |",
      "",
  ...
  writeFileSync(path.join(naPlaceholder, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(naPlaceholder, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(noCopyTable, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { onboarding: "done" }), "utf8");
  writeFileSync(path.join(noCopyTable, "product/ONBOARDING.md"), "# Onboarding\n\nFirst value then review popup, no table here.\n", "utf8");
  ...
  writeFileSync(path.join(emptyCopyCell, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(emptyCopyCell, "product/ONBOARDING.md"),
  ...
  writeFileSync(path.join(androidMechanism, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(androidMechanism, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |", ...NA_SURFACES, ""].join("\n"),
    "utf8",
  );
  writeFileSync(path.join(androidMechanism, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(androidMechanism, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(
    path.join(androidMechanism, "engineering/TECH_SPEC.md"),
  ...
  runFixture("App copy: missing state/PROJECT_STATE.yaml fails loudly", stateMissing, "check-app-copy.ts", 1, "project_state.missing");
  ...
  writeFileSync(path.join(icuPlural, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(icuPlural, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| today.done.headline | After check-in | {item_count, plural, one {# walk logged} other {# walks logged}} | | 1 |", ""].join("\n"),
    "utf8",
  );
  writeFileSync(
    path.join(icuPlural, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(mechanismOutOfSection, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismOutOfSection, "engineering/TECH_SPEC.md"),
    [
      "# Technical Spec",
      "",
      "## Data Contract",
  ...
  writeFileSync(path.join(badPunctuationRef, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(badPunctuationRef, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(allowlistNoReason, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(allowlistNoReason, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(deckInlineCode, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(deckInlineCode, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(allowlistSubstring, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(allowlistSubstring, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(allowlistInflected, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(allowlistInflected, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(
    path.join(allowlistInflected, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(deckUnderscoreKey, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(deckUnderscoreKey, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(tierRequired, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(tierRequired, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | |", ...NA_SURFACES, ""].join("\n"),
    "utf8",
  );
  writeFileSync(path.join(tierRequired, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(tierRequired, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(mechanismRejected, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismRejected, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(deckNoOuterPipes, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(deckNoOuterPipes, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "onboarding.promise.headline | Promise | Product-specific value promise | | 1", ""].join("\n"),
    "utf8",
  );
  ...
  writeFileSync(path.join(engineeringPartial, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "partial" }), "utf8");
  rmSync(path.join(engineeringPartial, "product/copy/COPY_DECK.md"));
  ...
  writeFileSync(path.join(mechanismComplianceNote, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismComplianceNote, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |", ...NA_SURFACES, ""].join("\n"),
    "utf8",
  );
  writeFileSync(path.join(mechanismComplianceNote, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(mechanismComplianceNote, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(
    path.join(mechanismComplianceNote, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(planRouteDropped, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "partial" }), "utf8");
  writeFileSync(path.join(planRouteDropped, "engineering/ENGINEERING_PLAN.md"), "# Engineering Plan\n\nBuild the screens per product/SPEC.md.\n", "utf8");
  ...
  // without an authored product/copy/COPY_BRIEF.md shipped conversion copy voice-blind.
  const briefConversionLane = makeFixture("app-copy-brief-conversion-lane");
  writeFileSync(path.join(briefConversionLane, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { revenue: "done" }), "utf8");
  ...
  writeFileSync(path.join(deckPhaseWord, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(deckPhaseWord, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(flatKeyRef, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(flatKeyRef, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(mechanismSuffixNegation, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismSuffixNegation, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(planMissing, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "partial" }), "utf8");
  rmSync(path.join(planMissing, "engineering/ENGINEERING_PLAN.md"));
  ...
  writeFileSync(path.join(mechanismUndecided, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismUndecided, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(deckCommentedRows, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckCommentedRows, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(deckCommentedRows, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(deckCommentedRows, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(deckNoDate, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckNoDate, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored",
  ...
  writeFileSync(path.join(spacedKeyRef, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(spacedKeyRef, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(briefBoilerplate, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { revenue: "done" }), "utf8");
  const templateBrief = readFileSync(path.join(briefBoilerplate, "product/copy/COPY_BRIEF.md"), "utf8");
  writeFileSync(path.join(briefBoilerplate, "product/copy/COPY_BRIEF.md"), templateBrief.replace(/^Status:.*$/m, "Status: authored 2026-07-29"), "utf8");
  ...
  writeFileSync(path.join(deckCommentedExemptions, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckCommentedExemptions, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(deckCommentedExemptions, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(deckCommentedExemptions, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(planNegatedRoute, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "partial" }), "utf8");
  writeFileSync(
    path.join(planNegatedRoute, "engineering/ENGINEERING_PLAN.md"),
    "# Engineering Plan\n\nDo not use product/copy/COPY_DECK.md; hardcode the strings for speed.\n",
    "utf8",
  );
  ...
  writeFileSync(path.join(engineeringBlocked, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "blocked" }), "utf8");
  rmSync(path.join(engineeringBlocked, "product/copy/COPY_DECK.md"));
  ...
  writeFileSync(path.join(allowlistPlaceholderReason, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(allowlistPlaceholderReason, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(mechanismExpoOnly, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismExpoOnly, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(briefCommented, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { revenue: "done" }), "utf8");
  writeFileSync(
    path.join(briefCommented, "product/copy/COPY_BRIEF.md"),
  ...
  writeFileSync(path.join(deckUnterminatedComment, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckUnterminatedComment, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: authored 2026-07-29",
  ...
  writeFileSync(path.join(deckUnterminatedComment, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(deckUnterminatedComment, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(nativeBrand, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  ...
  writeFileSync(path.join(mechanismArbOnly, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismArbOnly, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(deckCommentedStatus, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(deckCommentedStatus, "product/copy/COPY_DECK.md"),
    [
      "# Copy Deck",
      "",
      "Status: draft",
  ...
  writeFileSync(path.join(planCannotUse, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "partial" }), "utf8");
  writeFileSync(
    path.join(planCannotUse, "engineering/ENGINEERING_PLAN.md"),
    "# Engineering Plan\n\nWe cannot use product/copy/COPY_DECK.md for this sprint.\n",
    "utf8",
  );
  ...
  writeFileSync(path.join(mechanismCannotUse, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismCannotUse, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(deckTransformCollision, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(deckTransformCollision, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(planCommentedRoute, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "partial" }), "utf8");
  writeFileSync(
    path.join(planCommentedRoute, "engineering/ENGINEERING_PLAN.md"),
    "# Engineering Plan\n\n<!-- Builders use product/copy/COPY_DECK.md -->\n\nBuild the screens.\n",
    "utf8",
  );
  ...
  writeFileSync(path.join(specCommentedSection, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(specCommentedSection, "engineering/TECH_SPEC.md"),
  ...
  writeFileSync(path.join(nativeNestedBrand, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  ...
  writeFileSync(path.join(mechanismDontUse, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { engineering: "done" }), "utf8");
  writeFileSync(
    path.join(mechanismDontUse, "engineering/TECH_SPEC.md"),
  ...
  // A first fence whose only product/copy/COPY_DECK.md mention is negated certifies the
  ...
  writeFileSync(
    negatedPromptPath,
    readFileSync(negatedPromptPath, "utf8").replace(/```[\s\S]*?```/, ["```", "Do not use product/copy/COPY_DECK.md; hardcode the strings.", "```"].join("\n")),
    "utf8",
  );
  runFixture(
  ...
  writeFileSync(path.join(dartFileReference, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(dartFileReference, "product/copy/COPY_DECK.md"),
    [...DECK_HEADER, "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |", ""].join("\n"),
    "utf8",
  );
  writeFileSync(
    path.join(dartFileReference, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(naNextLine, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { design: "done" }), "utf8");
  writeFileSync(
    path.join(naNextLine, "product/copy/COPY_DECK.md"),
    [
      ...DECK_HEADER,
      "| onboarding.promise.headline | Promise | Small wins, every day | | 1 |",
      "",
  ...
  writeFileSync(path.join(naNextLine, "product/copy/COPY_BRIEF.md"), AUTHORED_BRIEF, "utf8");
  writeFileSync(
    path.join(naNextLine, "product/ONBOARDING.md"),
    [
      "# Onboarding",
      "",
      "| Step | Purpose | Copy / question | State |",
  ...
  writeFileSync(path.join(markupEmptyCell, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  writeFileSync(
    path.join(markupEmptyCell, "product/copy/COPY_DECK.md"),
  ...
  writeFileSync(path.join(testLiteralClean, "state/PROJECT_STATE.yaml"), stateWith("phase_2", {}), "utf8");
  mkdirSync(path.join(testLiteralClean, "__tests__"), { recursive: true });
  writeFileSync(
    path.join(testLiteralClean, "__tests__", "branding.test.ts"),
    [
      'import { strings } from "../../../tooling/lib/strings";',
  ...
  writeFileSync(path.join(briefMarkersDeleted, "state/PROJECT_STATE.yaml"), stateWith("phase_2", { revenue: "done" }), "utf8");
  writeFileSync(
    path.join(briefMarkersDeleted, "product/copy/COPY_BRIEF.md"),
    readFileSync(path.join(briefMarkersDeleted, "product/copy/COPY_BRIEF.md"), "utf8")
