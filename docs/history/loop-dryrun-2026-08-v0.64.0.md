...
>
> Nothing in the repo reads this file, and no entrypoint links it. See [the generated workflow inventory](../../skill/b2c-mobile-business-launch/runtime/graph/generated/skill-graph.md) for the inventory it audits.

Each loop in `skill/b2c-mobile-business-launch/runtime/graph/generated/skill-graph.md` is dry-run once on a representative
...
tightened the loop in `skill/b2c-mobile-business-launch/runtime/graph/generated/skill-graph.md` and re-ran; both the first
